...
$$
\text{模型权重} = \frac{\text{总参数量(B)} \times \text{每参数字节数}}{1024^{3}} \text{ GB}
$$
...
$$
\text{KV Cache} = \frac{2 \times \text{层数} \times \text{KV 头数} \times \text{头维度} \times \text{上下文长度} \times \text{并发数} \times \text{KV 每参数字节数}}{1024^{3}} \text{ GB}
$$
...
$$
\text{激活值} \approx \frac{\text{并发数} \times \text{上下文长度} \times \text{隐藏层大小} \times 18 \times \text{每参数字节数}}{1024^{3}} \text{ GB}
$$
